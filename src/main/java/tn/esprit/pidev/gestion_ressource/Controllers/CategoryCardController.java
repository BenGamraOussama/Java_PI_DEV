...
public class CategoryCardController {
    ...
    void handleupdate(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/tn/esprit/pidev/FXML/updateCategory.fxml"));
    ...
    public void setData(Category category) {
        ...
        if (category.getImage() != null && !category.getImage().isEmpty()) {
            File file = new File("src/main/resources/tn/eprit/pidev/uploads/" + category.getImage());
            if (file.exists()) {
