...
public class CategoryController {
    ...
    private void displayCategories(List<Category> categories) {
        ...
        for (Category category : categories) {
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/tn/esprit/pidev/FXML/categoryCard.fxml"));
    ...
    void handleAddCat(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/tn/esprit/pidev/FXML/addCategory.fxml"));
    ...
    void handleBackToHome() throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/tn/esprit/pidev/FXML/home.fxml"));
