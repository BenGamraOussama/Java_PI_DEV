...
public class EmailService {
    ...
    private static final String EMAIL_USERNAME = "novateeam@gmail.com"; // Replace with actual email
    private static final String EMAIL_PASSWORD = "ibmb joyl dhyz jxod"; // Replace with actual password
