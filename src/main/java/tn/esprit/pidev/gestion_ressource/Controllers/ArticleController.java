...
public class ArticleController {
    ...
    void handleAddArticle(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/tn/esprit/pidev/FXML/addArticle.fxml"));
    ...
    private void displayArticles(List<Article> articles) {
        ...
        for (Article article : articles) {
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/tn/esprit/pidev/FXML/articleCard.fxml"));
