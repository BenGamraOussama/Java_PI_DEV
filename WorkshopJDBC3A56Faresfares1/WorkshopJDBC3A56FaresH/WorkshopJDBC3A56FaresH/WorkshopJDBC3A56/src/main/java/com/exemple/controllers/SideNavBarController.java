...
public class SideNavBarController {
    ...
    void openProduitList(MouseEvent event) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/FXML/ligneCommande/LigneCommandeView.fxml"));
    ...
    void openCommandeList(MouseEvent event) {
        try {
            // Charger le fichier FXML de listArticleAdmin
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/FXML/commande/AddCommande.fxml"));
